    ...
    <ul>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="my-artistic-self.php" class="<?php echo isCurrentPage('my-artistic-self.php'); ?>">My Artistic Self</a>
                <a href="my-dream-vacation.php" class="<?php echo isCurrentPage('my-dream-vacation.php'); ?>">My Dream Vacation</a>
            </div>
        </li>
        <li><a href="marketplace.php" class="<?php echo isCurrentPage('marketplace.php'); ?>">Marketplace</a></li>
        <li><a href="contact.php" class="<?php echo isCurrentPage('contact.php'); ?>">Contact</a></li>
    </ul>
